    ...
    <div className="min-h-screen bg-background bg-mesh-gradient">
      ...
      <main className="container mx-auto px-4 py-8 space-y-16">
        ...
        <section className="relative py-16 bg-hero-gradient overflow-hidden">
          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-gradient-to-br from-primary/10 to-purple-500/10 rounded-full blur-3xl"></div>
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square max-w-md mx-auto relative">
                ...
                <div className="relative bg-card rounded-3xl overflow-hidden border shadow-soft-lg">
                  <ImageWithFallback
        ...
        {/* About Section */}
        <section id="about" className="py-16 bg-section-gradient relative">
        ...
        {/* Projects Section */}
        <section id="projects" className="py-16 bg-section-gradient relative">
