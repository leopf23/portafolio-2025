...
import { ImageWithFallback, ThemeToggle } from "../molecules"
import { 
  MapPin, 
  Mail, 
  Phone, 
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 bg-background">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-transparent rounded-full blur-3xl animate-float"></div>
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-gradient-to-br from-purple-500/10 to-transparent rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-gradient-to-br from-pink-500/10 to-transparent rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button size="lg" className="gap-2 glass-effect">
                    <Download className="h-4 w-4" />
                    Download CV
                  </Button>
                  <Button variant="outline" size="lg" className="gap-2 glass-effect">
              ...
              <div className="relative">
                <div className="aspect-square max-w-md mx-auto relative">
                  ...
                  <div className="relative bg-card rounded-3xl overflow-hidden border shadow-soft-lg glass-effect">
                    <ImageWithFallback
                      ...
                      alt="Leonardo Pérez - UI/UX Designer"
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8">
                {experience.map((job, index) => (
                  <Card key={index} className="p-6 glass-effect hover:shadow-soft-lg transition-all duration-300 animate-fade-in">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                  <Card key={index} className="group overflow-hidden glass-effect hover:shadow-glow transition-all duration-500 animate-slide-up">
                    ...
                    <CardContent className="p-6 space-y-4">
                      ...
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="w-full group glass-effect"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">leonardo.perez@email.com</p>
                      </div>
                    </div>
        ...
        {/* Footer */}
        <footer className="border-t border-border py-8 glass-effect">
        ...
        {showScrollTop && (
          <Button
            onClick={scrollToTop}
            size="sm"
            className="fixed bottom-6 right-6 h-12 w-12 rounded-full shadow-glow glass-effect z-50 p-0 animate-float hover:animate-glow transition-all duration-300"
          >
